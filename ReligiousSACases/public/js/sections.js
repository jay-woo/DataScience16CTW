...
var scrollVis = function() {
  ...
  var yCathValue = function(d) { return d["NormalizedCount"] ; }; // data -> value
        ...
        .enter().append("circle")
          ...
          .on("mouseover", function(d) {
              ...
              tooltip.transition()
                ...
                .style("opacity", .9)
                .style("fill", "#fff");
              tooltip.html("<h1 style = 'color: white'>" + d["State"] + "</h1> <br/> <h4 style = 'color: white'>" + "Percent Catholic Per State:" + xCathValue(d) + "<br> Number of Sexual Assault Cases:" +  Math.round(yCathValue(d)*100)/100 + "</h4>" + "<img style = 'width: 100%; height: auto' src= 'images/" + d["State"] + ".png'>")
